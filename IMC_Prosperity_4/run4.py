...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        for product in state.order_depths:
            ...
            imbalance = np.tanh((total_bid - total_ask) / (total_bid + total_ask + 1e-6))
            ...
            if abs(trend) > 6 and vol > 2.1:
                ...
                # #  EXIT if reversal detected
                # if trend > 0 and short_trend < 0 and position > 0:
